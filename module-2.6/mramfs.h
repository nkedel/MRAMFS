...
// ENABLE ME IF YOU WANT INSTRUMENTATION
// #define INSTRUMENT

// ENABLE ME IF YOU WANT DELAY SUPPORT
// #define DELAY
...
#define CBUF_DEFAULT_LENGTH	8192
...
int decomp_inode_null( struct inode *inode, unsigned int *dest, int bits );
...
#else 
void mramfs_put_super( struct super_block *s );
#endif

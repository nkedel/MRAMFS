/*
*  lookup.c
*  Implements an optimized hash function
*
* By Bob Jenkins, 1996.  bob_jenkins@burtleburtle.net.
* You may use this code any way you wish, private,
* educational, or commercial.  It's free.
*
* See http://burlteburtle.net/bob/hash/evahash.html
*
* Minor additions by Nate Edel for mramfs
*
*/
...
ub4 hash_ugp( unsigned short uid, unsigned short gid, unsigned short mode ) {
  register ub4 ugid = uid + ( ( ub4 ) gid << 16 );
  register ub4 mfoo = mode << 8;
  register ub4 result = 0x9e3779b9;
  //    printk(KERN_NOTICE "UGID = %08x (%04x,%04x) / MFOO = %08x (%04x)",ugid,uid,gid,mfoo,mode);
  mix( ugid, mfoo, result );
  //    printk(KERN_NOTICE "UGID = %08x / MFOO = %08x / RESULT = %08x",ugid,mfoo,result);
  return result;
}
